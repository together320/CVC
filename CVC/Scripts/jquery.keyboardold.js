...
; (function (factory) {
    ...
    var $keyboard = $.keyboard = function (el, options) {
        ...
        base.close = function (accepted) {
           //$("#s2id_autogen1_search").val("pack1");
           // $("#s2id_autogen1_search").trigger("keyup");
            //$(".select2-results option:contains('pack1')").attr('selected', 'selected');
           
            //$('#select2-results-1 li:eq(1)').prop('selected', true);
            //$("#select2-results-1 ").val(1).trigger();
           


           // $('.select2-results').trigger('change'); // Notify any JS components that the value changed
           // $('.select2-results').innerHTML()

          //  console.log($('.select2-results').innerHTML());
