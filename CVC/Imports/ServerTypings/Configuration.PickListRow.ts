namespace CVC.Configuration {
    ...
    export namespace PickListRow {
        export const idProperty = 'PickListId';
        export const nameProperty = 'PickListName';
        export const localTextPrefix = 'Configuration.PickList';
        export const lookupKey = 'Configuration.PickList';

        export function getLookup(): Q.Lookup<PickListRow> {
            return Q.getLookup<PickListRow>('Configuration.PickList');
        }
