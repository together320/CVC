namespace CVC.MachineCustomization {
    export interface MachineMaintenanceScheduleRow {
    ...
    export namespace MachineMaintenanceScheduleRow {
        export const idProperty = 'MachineMainSchId';
        export const nameProperty = 'Description';
        export const localTextPrefix = 'MachineCustomization.MachineMaintenanceSchedule';
