namespace CVC.MachineCustomization {
    ...
    export namespace MachineHistoryRow {
        export const idProperty = 'MachineHistoryId';
        export const nameProperty = 'ProblemDescription';
        export const localTextPrefix = 'MachineCustomization.MachineHistory';
