namespace CVC.ModuleManagement {
    ...
    export namespace ModuleRow {
        export const idProperty = 'ModuleId';
        export const nameProperty = 'ModuleName';
        export const localTextPrefix = 'ModuleManagement.Module';
        export const lookupKey = 'ModuleManagement.Module';

        export function getLookup(): Q.Lookup<ModuleRow> {
            return Q.getLookup<ModuleRow>('ModuleManagement.Module');
        }
        export const deletePermission = 'ModuleManagement:Module:Modify';
        export const insertPermission = 'ModuleManagement:Module:Modify';
        export const readPermission = 'ModuleManagement:Module:Read';
        export const updatePermission = 'ModuleManagement:Module:Modify';
