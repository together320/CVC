namespace CVC.MachineCustomization {
    export interface MachineHelpFileRow {
    ...
    export namespace MachineHelpFileRow {
        export const idProperty = 'MachineHelpFileId';
        export const nameProperty = 'FileName';
        export const localTextPrefix = 'MachineCustomization.MachineHelpFile';
