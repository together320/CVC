namespace CVC.Configuration {
    ...
    export namespace DepartmentRow {
        ...
        export const nameProperty = 'DepartmentCode';
        export const localTextPrefix = 'Configuration.Department';
        export const lookupKey = 'Configuration.Department';

        export function getLookup(): Q.Lookup<DepartmentRow> {
            return Q.getLookup<DepartmentRow>('Configuration.Department');
        }
        export const deletePermission = 'Configuration:Department:Modify';
        export const insertPermission = 'Configuration:Department:Modify';
        export const readPermission = 'Configuration:Department:Read';
        export const updatePermission = 'Configuration:Department:Modify';
