namespace CVC.ExternalApplicationInterface {
    ...
    export namespace ProtocolRow {
        export const idProperty = 'ProtocolId';
        export const nameProperty = 'ProtocolName';
        export const localTextPrefix = 'ExternalApplicationInterface.Protocol';
        export const lookupKey = 'ExternalApplicationInterface.Protocol';

        export function getLookup(): Q.Lookup<ProtocolRow> {
            return Q.getLookup<ProtocolRow>('ExternalApplicationInterface.Protocol');
        }
        export const deletePermission = 'EAI:Protocol:Modify';
        export const insertPermission = 'EAI:Protocol:Modify';
        export const readPermission = 'EAI:Protocol:Read';
        export const updatePermission = 'EAI:Protocol:Modify';
