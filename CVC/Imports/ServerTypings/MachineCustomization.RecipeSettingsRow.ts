namespace CVC.MachineCustomization {
    export interface RecipeSettingsRow {
    ...
    export namespace RecipeSettingsRow {
        export const idProperty = 'RecipeSettingsId';
        export const nameProperty = 'RecipeSettingsName';
        export const localTextPrefix = 'MachineCustomization.RecipeSettings';
