namespace CVC.MachineCustomization {
    export interface MachineSpecificationRow {
    ...
    export namespace MachineSpecificationRow {
        export const idProperty = 'MachineSpecId';
        export const nameProperty = 'Description';
        export const localTextPrefix = 'MachineCustomization.MachineSpecification';
