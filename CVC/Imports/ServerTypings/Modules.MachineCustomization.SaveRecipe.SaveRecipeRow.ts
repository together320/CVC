namespace CVC.Modules.MachineCustomization.SaveRecipe {
    export interface SaveRecipeRow {
    ...
    export namespace SaveRecipeRow {
        export const idProperty = 'MachineRecipeId';
        export const nameProperty = 'RecipeName';
        export const localTextPrefix = 'MachineCustomization.SaveRecipe';
        export const lookupKey = 'MachineCustomization.SaveRecipe';

        export function getLookup(): Q.Lookup<SaveRecipeRow> {
            return Q.getLookup<SaveRecipeRow>('MachineCustomization.SaveRecipe');
        }
        export const deletePermission = 'MachineCustomization:SaveRecipe:Modify';
        export const insertPermission = 'MachineCustomization:SaveRecipe:Modify';
        export const readPermission = 'MachineCustomization:SaveRecipe:Read';
        export const updatePermission = 'MachineCustomization:SaveRecipe:Modify';
