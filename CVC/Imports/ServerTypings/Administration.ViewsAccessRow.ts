namespace CVC.Administration {
    export interface ViewsAccessRow {
    ...
    export namespace ViewsAccessRow {
        export const idProperty = 'ViewsAccessId';
        export const localTextPrefix = 'Administration.ViewsAccess';
