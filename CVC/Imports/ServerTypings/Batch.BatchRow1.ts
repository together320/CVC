namespace CVC.Batch {
    ...
    export namespace BatchRow1 {
        export const idProperty = 'BatchId';
        export const nameProperty = 'BatchName';
        export const localTextPrefix = 'Batch.Batch';
        export const lookupKey = 'Batch1';

        export function getLookup(): Q.Lookup<BatchRow1> {
            return Q.getLookup<BatchRow1>('Batch1');
        }
