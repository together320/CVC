namespace CVC.Configuration {
    ...
    export namespace CompanyRow {
        ...
        export const deletePermission = 'Configuration:Company:Modify';
        export const insertPermission = 'Configuration:Company:Modify';
        export const readPermission = 'Configuration:Company:Read';
        export const updatePermission = 'Configuration:Company:Modify';
