namespace CVC.Batch {
    ...
    export namespace LabelRollRow {
        export const idProperty = 'LabelRollId';
        export const nameProperty = 'Remark';
        export const localTextPrefix = 'Batch.LabelRoll';
        export const lookupKey = 'Batch.LabelRollId';

        export function getLookup(): Q.Lookup<LabelRollRow> {
            return Q.getLookup<LabelRollRow>('Batch.LabelRollId');
        }
