namespace CVC.Administration {
    export interface ViewFieldAccessRow {
    ...
    export namespace ViewFieldAccessRow {
        export const idProperty = 'ViewFieldAccessId';
        export const localTextPrefix = 'Administration.ViewFieldAccess';
