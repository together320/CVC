namespace CVC.MachineCustomization {
    export interface AlarmResetIdRow {
    ...
    export namespace AlarmResetIdRow {
        export const idProperty = 'AlarmResetRoleId';
        export const localTextPrefix = 'MachineCustomization.AlarmResetId';
