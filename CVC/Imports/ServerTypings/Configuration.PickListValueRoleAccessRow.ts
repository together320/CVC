namespace CVC.Configuration {
    export interface PickListValueRoleAccessRow {
    ...
    export namespace PickListValueRoleAccessRow {
        export const idProperty = 'PickListValueRoleAccessId';
        export const localTextPrefix = 'Configuration.PickListValueRoleAccess';
