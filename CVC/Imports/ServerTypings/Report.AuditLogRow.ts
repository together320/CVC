namespace CVC.Report {
    ...
    export namespace AuditLogRow {
        export const idProperty = 'AuditLogId';
        export const nameProperty = 'UserName';
        export const localTextPrefix = 'Report.AuditLog';
        export const deletePermission = 'Report:AuditLog:Read';
        export const insertPermission = 'Report:AuditLog:Read';
        export const readPermission = 'Report:AuditLog:Read';
        export const updatePermission = 'Report:AuditLog:Read';
