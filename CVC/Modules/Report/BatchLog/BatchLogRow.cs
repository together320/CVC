...
// Type: CVC.Report.Entities.BatchLogRow
...
namespace CVC.Report.Entities
{
 ...
 // [ReadPermission("Administration:General")]
    ...
    public sealed class BatchLogRow : Row, IIdRow, IEntity, INameRow
  {
    ...
    public DateTime? UpdatedDateTime
    {
      ...
      set
      {
        ...
        //    get
        //    {
        //        return BatchLogRow.Fields.BatchVersion[(Row)this];
        //    }
        //    set
        //    {
        //        BatchLogRow.Fields.BatchVersion[(Row)this] = value;
        //    }
        //}
    ...
    public class RowFields : RowFieldsBase
    {
     ...
     // public StringField BatchVersion;
        ...
        : base((string) null, "")
      {
        this.LocalTextPrefix = "Report.BatchLog";
      }
    }
  }
}
