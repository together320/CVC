...
// Type: CVC.Configuration.Scripts.CityCountryLookup
...
{
  [LookupScript("Configuration.CityCountry", Permission = "Lookup")]
  public class CityCountryLookup : RowLookupScript<CityDetailsRow>
  {
