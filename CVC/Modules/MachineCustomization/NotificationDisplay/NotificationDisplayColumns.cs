...
namespace CVC.MachineCustomization.Columns
{
    ...
    [ColumnsScript("MachineCustomization.NotificationDisplay")]
    [BasedOnRow(typeof(Entities.NotificationDisplayRow), CheckNames = true)]
    public class NotificationDisplayColumns
    {
