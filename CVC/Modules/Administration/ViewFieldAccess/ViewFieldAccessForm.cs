...
// Type: CVC.Administration.Forms.ViewFieldAccessForm
...
{
    [FormScript("Administration.ViewFieldAccess")]
    [BasedOnRow(typeof(ViewFieldAccessRow))]
    public class ViewFieldAccessForm
    {
        [LookupEditor(typeof(ViewFieldRow))]
        [Required]
